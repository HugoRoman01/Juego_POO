...
public class ControladorNPC{
        ...
        do{
            ...
            for( Personajes personajes : Leer.personajes_list){
                if(personajes.getClass().equals(Jugador.class)){
                    ...
                    JuegoEntero(personajes, sc, Leer.personajes_list, Leer.localizaciones_list, Leer.objetos_list);
    ...
    public static void JuegoEntero(Personajes personajes, Scanner sc,List<Personajes> personajes_list, List<Lugares> localizaciones_list, List<Objetos> objetos_list ){
